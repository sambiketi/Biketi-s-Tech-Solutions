...
@app.route('/')
def home():
    return jsonify({'message': 'Agency Platform API', 'version': '1.0.0'})
...
if __name__ == '__main__':
    ...
    print("📊 Health: GET http://localhost:5000/api/v1/health")
    print("🔐 Login: POST http://localhost:5000/api/v1/admin/login")
    print("📈 Dashboard: GET http://localhost:5000/api/v1/admin/dashboard/stats")
    print("🛠️  Init Demo: POST http://localhost:5000/api/v1/init-demo")
